...
//[Информационный ролик о специальностях кафедры](https://www.youtube.com/watch?v=HsKNzXDoHps)
	if(mb_stripos($mtext,"Информация о кафедре") !== false){
		$k_img="http://web.kpi.kharkov.ua/cmps/wp-content/uploads/sites/144/2018/03/Plakat-min.jpg";
		$k_txt = '
 [⁠]($k_img)Вас приветствует коллектив кафедры компьютерного моделирования процессов и систем!
